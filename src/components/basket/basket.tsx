...
export default class Basket extends Component<{}, IBasketState> {
    constructor(props: {}) {
        super(props);
        this.state = {
            games: []
    ...
    remove = (game: IGame): void => {
        ...
        const BasketGames: IGame[] = JSON.parse(localStorage.getItem('basket') || '[]');
    ...
    render() {
        ...
        const totalPrice = games.reduce((acc, game) => {
