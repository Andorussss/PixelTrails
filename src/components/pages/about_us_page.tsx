    ...
    return (
        <div className={'container'}>
            ...
            <form>
                ...
                <input type="radio" id="contact-email" name="contact-method" value="email" defaultChecked />
                ...
                <input type="checkbox" id="subscribe" name="subscribe" value="subscribe" defaultChecked />
